...
2. Wählen Sie in der **[!UICONTROL Extension]** Dropdownliste **[!UICONTROL Places]**.
3. Wählen Sie aus der **[!UICONTROL Data Element Type]** Dropdownliste **[!UICONTROL Name]**.
4. Im rechten Fensterbereich können Sie auswählen, **[!UICONTROL Current POI]** welcher den Namen des POI abruft, in dem sich der Benutzer derzeit befindet.
...
5. Wiederholen Sie die Schritte 1 bis 4 und erstellen Sie Datenelemente für " *Letzter eingegebener POI-Breitengrad*", " *Zuletzt eingegebene POI-Längengrad*"und " *Zuletzt eingegebener POI-Radius*".
...
2. Klicken Sie unter dem **[!UICONTROL Events]** Abschnitt auf **[!UICONTROL +]** und wählen Sie **[!UICONTROL Places]** als Erweiterung aus.
...
6. Lassen Sie den **[!UICONTROL Conditions]** Abschnitt leer.

   In diesem Abschnitt können Sie filtern oder Einschränkungen festlegen, wann diese Regel ausgelöst werden soll.

7. Klicken Sie unter dem **[!UICONTROL Actions]** Abschnitt auf **[!UICONTROL +]**.
8. Wählen Sie in der **[!UICONTROL Extension]** Dropdownliste **[!UICONTROL Mobile Core]** und in der **[!UICONTROL Action Type]** Dropdownliste die Option **[!UICONTROL Send Postback]**.
9. In **[!UICONTROL URL]** diesem Fall müssen Sie den Endpunkt "Campaign Standard-Standorte"erstellen.
...
12. Geben Sie in **[!UICONTROL Content Type]** ein **[!UICONTROL application/json]**.
13. Klicken Sie auf **[!UICONTROL Keep Changes]**.
...
2. Wählen Sie für den Push-Benachrichtigungstyp **[!UICONTROL Send push to Campaign profiles]**.
3. Klicken Sie auf **[!UICONTROL Next]** und geben Sie die allgemeinen Details ein.
4. Klicken Sie im Anzeigebereich "Zielgruppe"auf **[!UICONTROL Count]** , um zu ermitteln, wie viele Benutzer die Push-Benachrichtigung gesendet werden soll.

   >[!TIP]
   >
   >In diesem Beispiel ist der Zähler 3, da es drei installierte Geräte gibt, auf denen die Anwendung getestet wird.

5. Erweitern Sie im linken Bereich die **[!UICONTROL Profile]** Registerkarte und ziehen Sie den **[!UICONTROL POI location]** Filter in den Hauptbereich.
...
10. Klicken Sie auf **[!UICONTROL Next]** , um die Erstellung der Push-Benachrichtigung für die Bereitstellung abzuschließen.
