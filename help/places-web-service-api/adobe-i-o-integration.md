...
>[!IMPORTANT]
>
>Wenn Sie sich nicht bei der Adobe I/O-Konsole anmelden können oder wenn der Experience Platform Location Service keine Option auf der Seite "Integrationen *erstellen"ist*, finden Sie Informationen zu den *Organisationsanforderungen* in der Übersicht[zu ](/help/places-web-service-api/places-web-services.md)Orten-Webdiensten.
