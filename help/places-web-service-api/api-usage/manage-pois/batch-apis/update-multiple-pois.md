...
seo-title: Mehrere POIs aktualisieren
description: Verwenden Sie die Batch-APIs, um mehrere POIs zu aktualisieren.
seo-description: Verwenden Sie die Batch-APIs, um mehrere POIs zu aktualisieren.
...
>[!IMPORTANT]
>
>Ersetzen Sie `<API KEY>`, `<TOKEN>`, `<ORGID>`und `<PATHTOBATCHUPDATEJSONFILE>` durch echte Werte.

## JSON-Beispieldatei

Im Folgenden finden Sie die JSON-Beispieldatei für die `batchUpdate` API:
