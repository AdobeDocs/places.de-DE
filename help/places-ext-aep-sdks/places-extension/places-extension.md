...
Navigieren Sie zum Adobe-Entwicklerportal, um die Dokumentation für die [Places SDK-Erweiterungen](https://developer.adobe.com/client-sdks/documentation/places/).
