...
# Aktualisieren mehrerer POIs {#update-multiple-pois}

Eine POST, mit der Sie mehrere POIs aktualisieren können.
...
Im Folgenden finden Sie die JSON-Beispieldatei für die API `batchUpdate`:
